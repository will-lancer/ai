...
class ModelResourceManifest:
    ...
    minimum_host_ram_gib: float = 10.5
    maximum_vcpus: int = 2
    per_seed_runtime_minutes: int = 90
    estimated_gpu_hours: int = 64
    estimated_drive_gb: int = 30
    ...
    def __post_init__(self) -> None:
        ...
        if self.minimum_host_ram_gib < 10.5 or self.maximum_vcpus > 2:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "minimum_host_ram_gib": self.minimum_host_ram_gib,
